...
class PhonebookTests {
	@Test
	public void instanceOfIndividual() {
		//Phonebook book = new Phonebook();
		//book.setNewIndividual("000", "000", "000");
		//List<User> testUsers = book.getUsers();
		//Class c = testUsers.get(0).getClass();
		//String s = c.getName();
		//Assert.assertEquals("Should be equal to ru.sibguti.Individual", "ru.sibguti.Individual", s);
	}
}
/**
* Main Test class
